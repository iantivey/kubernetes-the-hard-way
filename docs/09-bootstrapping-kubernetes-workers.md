...
wget -q --show-progress --https-only --timestamping \
  ...
  https://github.com/containerd/cri-containerd/releases/download/v1.0.2-beta.1/cri-containerd-1.0.2-beta.1.linux-amd64.tar.gz \
...
```
sudo tar -xvf cri-containerd-1.0.2-beta.1.linux-amd64.tar.gz -C /
```
